 ...
 * Generated at: 2014-11-07 07:26:57 UTC
...
public final class fileSystem_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if (hs.getAttribute("currentFolder") == null) {
	 ...
	 File lock = new File("D:/edms project/java-blog-aggregator-master/repository" + "/.lock");
	 System.out.println("lock file exist ? "+lock.exists());
	 if (lock.exists()) {
		 lock.delete();
        System.out.println(lock.delete()+" lock file exist ? "+lock.exists());
    }
	...
	Session jcrsession = repository.login(new SimpleCredentials(
      ...
      out.write("\t</div>\r\n");
      out.write("\t<a href=\"userDashboard\">\r\n");
