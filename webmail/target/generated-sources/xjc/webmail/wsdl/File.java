 ...
 *         &lt;element name="fileVersionsHistory" type="{http://edms.com/documentModule}fileVersionDetail" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class File {
    ...
    protected List<FileVersionDetail> fileVersionsHistory;
    ...
    /**
     * Gets the value of the fileVersionsHistory property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the fileVersionsHistory property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFileVersionsHistory().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link FileVersionDetail }
     * 
     * 
     */
    public List<FileVersionDetail> getFileVersionsHistory() {
        if (fileVersionsHistory == null) {
            fileVersionsHistory = new ArrayList<FileVersionDetail>();
        }
        return this.fileVersionsHistory;
    }
