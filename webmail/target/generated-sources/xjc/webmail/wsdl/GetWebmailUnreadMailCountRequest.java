...
@XmlRootElement(name = "getWebmailUnreadMailCountRequest", namespace = "http://webmail.com/Mailcount")
public class GetWebmailUnreadMailCountRequest {

    @XmlElement(namespace = "http://webmail.com/Mailcount", required = true)
