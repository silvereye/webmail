...
@XmlRootElement(name = "getWebmailAuthRequest", namespace = "http://webmail.com/Authentication")
public class GetWebmailAuthRequest {

    @XmlElement(namespace = "http://webmail.com/Authentication", required = true)
