	...
	public void listenScriptSession() {
		   ...
		   ScriptSessionListener listener=new ScriptSessionListener() {
			...
			public void sessionCreated(ScriptSessionEvent ev) {
				...
				//XMPPConnection xmppConnection=(XMPPTCPConnection)httpSession.getAttribute("id");
				String  loginUser=httpSession.getAttribute("id").toString();
				ScriptSession session=ev.getSession();
				session.setAttribute("scriptAttribute", loginUser);
