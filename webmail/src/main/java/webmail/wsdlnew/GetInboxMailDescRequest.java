...
@XmlRootElement(name = "getInboxMailDescRequest", namespace = "http://webmail.com/Inbox")
public class GetInboxMailDescRequest {

    @XmlElement(namespace = "http://webmail.com/Inbox", required = true)
