...
@XmlRootElement(name = "getWebmailMoveTrashRequest", namespace = "http://webmail.com/Movetrash")
public class GetWebmailMoveTrashRequest {

    @XmlElement(namespace = "http://webmail.com/Movetrash", required = true)
