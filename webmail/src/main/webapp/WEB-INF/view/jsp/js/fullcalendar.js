...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		return '<a  class="' + classes.join(' ') + '"' +
			...
			'>' +
				'<div class="fc-content ' + event.c+'" id="'+event.id+'" name="'+event.name+'" recurrenceID="'+event.recurrenceID+'" repeatStatus="'+event.repeatStatus+'" endDT="'+event.endDT+'" startDT="'+event.startDT+'">' +
					(this.isRTL ?
...
var View = FC.View = Class.extend({
	...
	reportEventDrop: function(event, dropLocation, largeUnit, el, ev) {
		...
		//alert("id="+event.id);
		//alert("days="+mutateResult.dateDelta._days);
		dropEventUpdate(event.name,event.id,mutateResult.dateDelta._data.days,mutateResult.dateDelta._data.hours,mutateResult.dateDelta._data.minutes);
	},
	...
	reportEventResize: function(event, resizeLocation, largeUnit, el, ev) {
		...
		calendar.reportEventChange(); // will rerender events
		resizeEventUpdate(event.name,event.id,mutateResult.durationDelta._data.days,mutateResult.durationDelta._data.hours,mutateResult.durationDelta._data.minutes);
	},
