...
(function (factory) {
    ...
    rgbaSupport = (function() {
        ...
        window.style = elem.style;
        window.style.cssText = 'background-color:rgba(0,0,0,.5)';
...
//			        });
                ...
                if (isValid()) {
                    updateOriginalInput(true);
                    hide();
					//alert(find_color.css( "background-color" ));
                }
            });
            ...
            if (!!initialColor) {
               ...
               // alert('Hi');
				...
				//alert(addColorToSelectionPalette(initialColor));
            }
            else {
                updateUI();
            }
        ...
        function updateUI() {
            ...
            var find_bg = dragger.css("background-color", flatColor.toHexString());
            ...
            if (!realColor && allowEmpty) {
                ...
                window.displayColor = realColor.toString(format);
            }

            // Update the text entry input as it changes happen
            if (opts.showInput) {
                window.textInput.val(displayColor);
            }
